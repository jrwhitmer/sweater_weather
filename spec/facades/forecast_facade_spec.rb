...
RSpec.describe ForecastFacade do
  it 'creates current_weather objects with appropriate keys', :vcr do
  ...
  xit 'creates daily weather objects with appropriate keys', :vcr do
    mapquest_info = MapquestFacade.get_lat_long('denver,co')
  ...
  xit 'creates hourly weather objects with appropriate keys', :vcr do
    mapquest_info = MapquestFacade.get_lat_long('denver,co')
